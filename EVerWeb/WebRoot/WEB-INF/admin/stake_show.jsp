	...
	<div class="main">
		<div class="w main">
			<form name="stakeForm" id="stakeForm"
				action="StakeAction_showCurrStake" method="post">
				<!--right-->
				<div class="right">
					<div class="o-mt">
						<H2>所有车桩信息</H2>
					...
					<div id="buy-area" class="m m5" data-widget="tabs">
						<div class="mc">
							<div align="right">
								<a href="StakeAction_showStakeInMap?status=-1"
									class="button button-royal button-small" onclick="check1();">
									<s></s>在地图中显示&gt;&gt;&gt;</a>
							...
							<div class="tb-void">
								<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
									...
									<TBODY id="tb" class="parent">
										<s:iterator value="stakes" id="stake">
											<TR id="track">
												<td><div class="id">
														<s:property value="#stake.id" />
													</div>
												</td>
												<td><div class="name">
														<s:property value="#stake.user.name" />
													</div>
												</td>
												<td><div class="phone">
														<s:property value="#stake.user.telephone" />
													</div>
												</td>
												<td><div class="stime">
														<s:property value="#stake.availableStime" />
													</div>
												</td>
												<td><div class="etime">
														<s:property value="#stake.availableEtime" />
													</div>
												</td>
												<td><div class="description" >
														<nobr><s:property value="#stake.description" /></nobr>
													</div>
												</td>
												<td><div class="available_cartype_id">
														<s:property value="#stake.carType.typeName" />
													</div>
												</td>
												<td>
													<div class="type">
												...
												<td><a href="StakeAction_loadUpdate?currentId=<s:property value="#stake.id" />"
													class="button button-action button-rounded  button-tiny">修改</a>
													<a href="StakeAction_deleteStake?currentId=<s:property value="#stake.id" />"
								...
								<div style="text-align:center">
									<jsp:include page="/inc/pager.jsp">
										<jsp:param value="StakeAction_showAllStake.action" name="url" />
