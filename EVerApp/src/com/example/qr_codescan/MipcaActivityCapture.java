...
import com.example.everapp.AStakeUseActivity;
import com.example.everapp.ChargestakeDetailActivity;
import com.example.everapp.OrderActivity;
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
		   ...
		   Intent intent=new Intent();
			intent.putExtra("codeString", resultString);
			intent.setClass(getActivity(), AStakeUseActivity.class);
